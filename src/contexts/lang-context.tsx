...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "games.intro": "Beyond web development, I explore real-time 3D environments as a personal passion. Unreal Engine 5 and Blender are my creative playgrounds — where I experiment with rendering, gameplay systems, and virtual world-building.",
    "games.stat1.value": "2+",
    "games.stat1.label": "Years in UE5",
    "games.stat2.value": "UE5",
    "games.stat2.label": "Primary Engine",
    "games.stat3.value": "3+",
    "games.stat3.label": "Prototypes Built",
    "games.stat4.value": "Lumen",
    "games.stat4.label": "Real-Time GI",
    "games.stack.title": "Game Dev Stack",
    "games.tech.ue5": "Real-time 3D environment creation, level design, and Blueprint gameplay scripting in Unreal Engine 5.",
    "games.tech.blueprint": "Event-driven visual scripting for game logic, character controllers, and interactive systems.",
    "games.tech.blender": "3D modelling, UV unwrapping, rigging, and animation for game-ready assets.",
    "games.tech.nanite": "Leveraging UE5's virtualized geometry (Nanite) and real-time global illumination (Lumen) for cinematic quality.",
    "games.projects.title": "Prototypes & Experiments",
    "game.openworld.name": "Open World Prototype",
    "game.openworld.desc": "Large-scale UE5 landscape with dynamic sky, PCG foliage, Nanite terrain, and Lumen lighting. Exploring procedural generation pipelines.",
    "game.blenderchar.name": "Character Pipeline",
    "game.blenderchar.desc": "Full character workflow: Blender sculpt → retopo → rigging → UE5 import. Studying animation state machines and IK systems.",
    "game.vfxdemo.name": "Real-Time VFX Demo",
    "game.vfxdemo.desc": "Niagara particle system experiments — fire, magic effects, and GPU sprite emitters with custom HLSL expressions.",
    "games.private.note": "More experiments live in private repos. Game dev is a continuous personal journey alongside professional web work.",
  ...
  th: {
    ...
    "games.intro": "นอกจากงาน Web Dev ผมยังสำรวจโลก 3D real-time เป็นงานอดิเรกส่วนตัว Unreal Engine 5 และ Blender คือสนามเด็กเล่นสร้างสรรค์ที่ผมทดลองระบบ Rendering, Gameplay และการสร้างโลกเสมือน",
    "games.stat1.value": "2+",
    "games.stat1.label": "ปีใน UE5",
    "games.stat2.value": "UE5",
    "games.stat2.label": "Engine หลัก",
    "games.stat3.value": "3+",
    "games.stat3.label": "โปรโตไทป์ที่สร้าง",
    "games.stat4.value": "Lumen",
    "games.stat4.label": "Real-Time GI",
    "games.stack.title": "Game Dev Stack",
    "games.tech.ue5": "สร้างสภาพแวดล้อม 3D real-time ออกแบบ Level และเขียน Blueprint Gameplay ใน Unreal Engine 5",
    "games.tech.blueprint": "Visual Scripting แบบ Event-driven สำหรับ Logic เกม Character Controller และระบบ Interactive",
    "games.tech.blender": "Modelling 3D, UV Unwrap, Rigging และ Animation เพื่อสร้าง Asset สำหรับเกม",
    "games.tech.nanite": "ใช้ Virtualized Geometry (Nanite) และ Real-time Global Illumination (Lumen) ของ UE5 เพื่อคุณภาพระดับ Cinematic",
    "games.projects.title": "โปรโตไทป์และการทดลอง",
    "game.openworld.name": "Open World Prototype",
    "game.openworld.desc": "Landscape ขนาดใหญ่ใน UE5 พร้อม Dynamic Sky, PCG Foliage, Nanite Terrain และ Lumen Lighting สำรวจ Pipeline การสร้างแบบ Procedural",
    "game.blenderchar.name": "Character Pipeline",
    "game.blenderchar.desc": "ขั้นตอนการสร้างตัวละครเต็มรูปแบบ: Blender Sculpt → Retopo → Rigging → Import ใน UE5 ศึกษา Animation State Machine และ IK System",
    "game.vfxdemo.name": "Real-Time VFX Demo",
    "game.vfxdemo.desc": "ทดลอง Niagara Particle System — ไฟ, เอฟเฟกต์เวทย์มนตร์ และ GPU Sprite Emitter พร้อม HLSL Expression แบบกำหนดเอง",
    "games.private.note": "มีการทดลองเพิ่มเติมใน Private Repo ต่างๆ Game Dev คือการเดินทางส่วนตัวที่ทำควบคู่กับงาน Web ระดับมืออาชีพ",
